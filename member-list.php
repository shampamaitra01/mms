    ...
    <div class="card-header py-3">
      ...
      <div class="row">
        ...
        <div class="form-group col-md-2">
           <a href="allmember" class="btn btn-outline-success" target="_blank"><i class="fas fa-align-justify"></i> All Member</a>
        </div>
        <div class="form-group col-md-2">
           <a href="all-meeting" class="btn btn-outline-success"><i class="fas fa-align-justify"></i> See All List</a>
        </div>
...
<!-- Only for Update the list name Section-->
...
<!--           <input type="hidden" name="hidden_teacher_image" id="hidden_teacher_image" value="" />
          ...
          <input type="hidden" name="memberListPage" value="member-list" />
        ...
        <div class="modal-body">
          <div class="form-group">
            <div class="row">
              <label class="col-md-4 text-right">Name of the list<span class="text-danger">*</span></label>
              <div class="col-md-8">
                <input type="text" name="memListType_name" id="memListType_name" class="form-control" required="" />
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-8">
                ...
                <select name="meeting_member_list" id="meeting_member_list" class="form-control meeting_member_list selectpicker" multiple data-live-search="true" required="">
...
//Code for Member Catory Types
 ...
 function loadMemListAndCategoty(isSetMemList,memListcategory_id){
          $.ajax({
            ...
            method:"POST",
            data:{actionForMemlist:'fetchAll', isSetMemList:isSetMemList},
        ...
        loadMemListAndCategoty('isSetMemListCategory');        
